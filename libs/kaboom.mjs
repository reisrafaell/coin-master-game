...
var fi = (s, t, c) =>
  t in s
    ? Rn(s, t, { enumerable: !0, configurable: !0, writable: !0, value: c })
    : (s[t] = c)
var o = (s, t) => Rn(s, "name", { value: t, configurable: !0 })
var mi = (s, t) => {
  for (var c in t) Rn(s, c, { get: t[c], enumerable: !0 })
}
...
var ae = class {
  ...
  I = ae
o(I, "Color"),
  Ee(I, "RED", new ae(255, 0, 0)),
  Ee(I, "GREEN", new ae(0, 255, 0)),
  Ee(I, "BLUE", new ae(0, 0, 255)),
  Ee(I, "YELLOW", new ae(255, 255, 0)),
  Ee(I, "MAGENTA", new ae(255, 0, 255)),
  Ee(I, "CYAN", new ae(0, 255, 255)),
  Ee(I, "WHITE", new ae(255, 255, 255)),
  Ee(I, "BLACK", new ae(0, 0, 0))
function J(...s) {
...
var Q = class {
  ...
  invert() {
    ...
    ;(t[0] = this.m[5] * c - this.m[6] * g + this.m[7] * E),
      (t[4] = -(this.m[4] * c - this.m[6] * M + this.m[7] * K)),
      (t[8] = this.m[4] * g - this.m[5] * M + this.m[7] * V),
      (t[12] = -(this.m[4] * E - this.m[5] * K + this.m[6] * V)),
      (t[1] = -(this.m[1] * c - this.m[2] * g + this.m[3] * E)),
      (t[5] = this.m[0] * c - this.m[2] * M + this.m[3] * K),
      (t[9] = -(this.m[0] * g - this.m[1] * M + this.m[3] * V)),
      (t[13] = this.m[0] * E - this.m[1] * K + this.m[2] * V),
      (t[2] = this.m[1] * _ - this.m[2] * ee + this.m[3] * ce),
      (t[6] = -(this.m[0] * _ - this.m[2] * U + this.m[3] * W)),
      (t[10] = this.m[0] * h - this.m[1] * U + this.m[3] * Y),
      (t[14] = -(this.m[0] * ce - this.m[1] * W + this.m[2] * Y)),
    ...
    let ie =
      this.m[0] * t[0] + this.m[1] * t[4] + this.m[2] * t[8] + this.m[3] * t[12]
  ...
  rt = class {
    ...
    genAny(...t) {
      ...
      if (t.length === 1) {
        ...
        if (t[0] instanceof I && t[1] instanceof I)
...
function Bn(s, t) {
  ...
  for (let E = 0, M = g.length - 1; E < g.length; M = E++)
    g[E].y > t.y != g[M].y > t.y &&
      t.x < ((g[M].x - g[E].x) * (t.y - g[E].y)) / (g[M].y - g[E].y) + g[E].x &&
      (c = !c)
  return c
}
...
var De = class {
  ...
  on(t, c) {
    return (
      this.handlers[t] || (this.handlers[t] = new ve()), this.handlers[t].add(c)
    )
  }
  onOnce(t, c) {
    let g = this.on(t, (...E) => {
...
function Ln(s, t) {
  ...
  if (c === "object" && g === "object" && s !== null && t !== null) {
    ...
    for (let K of E) {
      let V = s[K],
        _ = t[K]
      if (!(typeof V == "function" && typeof _ == "function") && !Ln(V, _))
        return !1
    }
    return !0
  }
...
var Or = o((s) => {
  ...
  function ft() {
    ...
    for (let d of t.gamepads) {
      ...
      for (let j = 0; j < b.buttons.length; j++)
        b.buttons[j].pressed
          ? (re.buttonState.down.has(L.buttons[j]) ||
              (t.mergedGamepadState.buttonState.press(L.buttons[j]),
              re.buttonState.press(L.buttons[j]),
              t.events.trigger("gamepadButtonPress", L.buttons[j])),
            t.events.trigger("gamepadButtonDown", L.buttons[j]))
          : re.buttonState.down.has(L.buttons[j]) &&
            (t.mergedGamepadState.buttonState.release(L.buttons[j]),
            re.buttonState.release(L.buttons[j]),
            t.events.trigger("gamepadButtonRelease", L.buttons[j]))
      for (let j in L.sticks) {
        let Oe = L.sticks[j],
          Ie = new v(b.machados[Oe.x], b.machados[Oe.y])
        re.stickState.set(j, Ie),
          t.mergedGamepadState.stickState.set(j, Ie),
          t.events.trigger("gamepadStick", j, Ie)
      }
    }
  }
  o(ft, "processGamepad")
    ...
    gn.has(d.key) && d.preventDefault(),
      t.events.onOnce("input", () => {
        ...
        b.length === 1
          ...
          d.repeat
            ? (t.keyState.pressRepeat(b), t.events.trigger("keyPressRepeat", b))
            : (t.keyState.press(b),
    ...
    (de.touchstart = (d) => {
      d.preventDefault(),
        t.events.onOnce("input", () => {
          ...
          s.touchToMouse !== !1 &&
            ((t.mousePos = new v(b[0].clientX - C.x, b[0].clientY - C.y)),
            t.mouseState.press("left"),
            t.events.trigger("mousePress", "left")),
            b.forEach((L) => {
              t.events.trigger(
                "touchStart",
                new v(L.clientX - C.x, L.clientY - C.y),
                L
              )
            })
        })
  ...
  Wt = {
    ...
    easeInOutBack: (s) =>
      s < 0.5
        ...
        : (Math.pow(2 * s - 2, 2) * ((Xt + 1) * (s * 2 - 2) + Xt) + 2) / 2,
    easeInElastic: (s) =>
      s === 0
        ? 0
        : s === 1
    ...
    easeInOutElastic: (s) =>
      s === 0
        ...
        ? 1
        : s < 0.5
        ? -(Math.pow(2, 20 * s - 10) * Math.sin((20 * s - 11.125) * Mr)) / 2
        : (Math.pow(2, -20 * s + 10) * Math.sin((20 * s - 11.125) * Mr)) / 2 +
          1,
...
var mo = o((s = {}) => {
  ...
  E
    ? (_.push(`width: ${M}px`), _.push(`height: ${K}px`))
    : (_.push("width: 100%"), _.push("height: 100%")),
    s.crisp &&
      (_.push("image-rendering: pixelated"),
      _.push("image-rendering: crisp-edges")),
    (c.style.cssText = _.join(";")),
    (c.tabIndex = 0)
  let ee = document.createElement("canvas")
  ;(ee.width = Vr), (ee.height = Vr)
  let ce = ee.getContext("2d", { willReadFrequently: !0 }),
    U = Or({
      canvas: c,
  ...
  class pe {
    ...
    constructor(n, r) {
      ;(this.canvas = document.createElement("canvas")),
        ...
        (this.tex = Y.fromImage(this.canvas)),
  ...
  let w = (() => {
    let e = ft(_n, Hn),
      ...
      r =
        s.width && s.height
          ? new Ge(s.width * V, s.height * V)
          : new Ge(h.drawingBufferWidth, h.drawingBufferHeight),
      i = null,
      u = 1
    s.background &&
      ((i = I.fromArray(s.background)),
      (u = s.background[3] ?? 1),
    ...
    static fromImage(n, r = {}) {
      let [i, u] = B.packer.add(n),
        l = r.frames
          ? r.frames.map(
              (a) =>
                new Z(u.x + a.x * u.w, u.y + a.y * u.h, a.w * u.w, a.h * u.h)
            )
  ...
  let he = (() => {
    ...
    return (
      e
        .decodeAudioData(kn.buffer.slice(0))
        .then((i) => {
          r.buf = i
        })
        .catch((i) => {
  ...
  function on(e, n, r, i, u = {}) {
    return B.bitmapFonts.add(
      e,
      Qe(n).then((l) => de(Y.fromImage(l, u), r, i, u.chars ?? Br))
    )
  }
  o(on, "loadBitmapFont")
  function St(e = 1, n = 1, r = 0, i = 0, u = 1, l = 1) {
    let a = [],
      ...
      f = l / n
    for (let p = 0; p < n; p++)
      for (let x = 0; x < e; x++) a.push(new Z(r + x * m, i + p * f, m, f))
    return a
  }
  o(St, "slice")
  function Ct(e, n) {
    ...
    return Array.isArray(n)
      ? n.some((i) => typeof i == "string")
        ? B.sprites.add(
            e,
            Promise.all(
              n.map((i) => (typeof i == "string" ? Qe(i) : Promise.resolve(i)))
            ).then((i) => Tt(i, r))
          )
  ...
  function pt() {
    ...
    let e = w.width,
      n = w.height
    ;(w.width = h.drawingBufferWidth / V),
      (w.height = h.drawingBufferHeight / V),
      Ie({
        flipY: !0,
  ...
  function Ce(e) {
    ...
    if (e.radius) {
      ...
      l = [
        new v(a, 0),
        new v(n - a, 0),
        ...gt(new v(n - a, a), a, a, 270, 360),
        new v(n, a),
        new v(n, r - a),
        ...gt(new v(n - a, r - a), a, a, 0, 90),
        new v(n - a, r),
        new v(a, r),
        ...gt(new v(a, r - a), a, a, 90, 180),
        new v(0, r - a),
        new v(0, a),
        ...gt(new v(a, a), a, a, 180, 270),
      ]
    }
    qe(
      Object.assign({}, e, {
    ...
    if (!(n.length < 2))
      if (e.radius && n.length >= 3) {
        ...
        for (let r = 0; r < n.length - 1; r++)
          wt(Object.assign({}, e, { p1: n[r], p2: n[r + 1] })),
            e.join !== "none" &&
              Ze(Object.assign({}, e, { pos: n[r], radius: e.width / 2 }))
  }
  o(qn, "drawLines")
  function $n(e) {
    if (!e.p1 || !e.p2 || !e.p3)
  ...
  function qe(e) {
    ...
    if (!(n < 3)) {
      if (
        (re(), b(e.pos), C(e.scale), L(e.angle), b(e.offset), e.fill !== !1)
      ) {
  ...
  function $e(e) {
    ...
    if (n instanceof _e || typeof n == "string") {
      let H = n instanceof _e ? n.fontface.family : n,
        q =
          n instanceof _e
            ...
            : { outline: 0, filter: qr },
        F = wn[H] ?? {
          font: { tex: new Y(jr, Nr, { filter: q.filter }), map: {}, size: Ir },
          cursor: new v(0),
          outline: q.outline,
        }
      ...
      for (let Ue of u)
        if (!F.font.map[Ue]) {
          let y = ce
          y.clearRect(0, 0, ee.width, ee.height),
            (y.font = `${n.size}px ${H}`),
            (y.textBaseline = "top"),
            (y.textAlign = "left"),
            (y.fillStyle = "#ffffff")
          ...
          n.tex.update(k, F.cursor.x, F.cursor.y),
            (n.map[Ue] = new Z(F.cursor.x, F.cursor.y, P, G)),
            (F.cursor.x += P)
        }
    }
    let l = e.size || n.size,
...
`
    ...
    $.push({ width: p - f, chars: N }), (D += l), e.width && (x = e.width)
    let te = []
    for (let H of $) {
      ...
      for (let F of H.chars) {
        let Ue = n.map[F.ch],
          y = te.length
        if (
          ((F.pos = F.pos.add(q, 0).add(Ue.w * a.x * 0.5, Ue.h * a.y * 0.5)),
          e.transform)
        ) {
          let R =
      ...
      l = {
        ...
        remove(a) {
          ...
          if (m !== -1) {
            ...
            let f = o((p) => {
              p.trigger("destroy"),
                T.events.trigger("destroy", p),
                p.children.forEach((x) => f(x))
            }, "trigger")
            f(a)
          }
        },
        removeAll(a) {
          if (a) this.get(a).forEach((m) => this.remove(m))
  ...
  function gs(...e) {
    e.length === 1 || e.length === 2
      ? ((w.bgColor = J(e[0])), e[1] && (w.bgAlpha = e[1]))
      : (e.length === 3 || e.length === 4) &&
        ((w.bgColor = J(e[0], e[1], e[2])), e[3] && (w.bgAlpha = e[3])),
      h.clearColor(
        w.bgColor.r / 255,
        w.bgColor.g / 255,
        w.bgColor.b / 255,
  ...
  function Nt(...e) {
    return {
      ...
      drawInspect() {
        Ze({ color: J(255, 0, 0), radius: 4 / Yn() })
      },
    }
  }
  o(Nt, "pos")
  ...
  function Ts(e = {}) {
    ...
    return {
      ...
      drawInspect() {
        ...
        let u = {
          outline: { width: 4 / Yn(), color: J(0, 0, 255) },
          anchor: this.anchor,
          fill: !1,
          fixed: this.fixed,
        }
        i instanceof ne
          ...
          : i instanceof Pe
          ? qe({ ...u, pts: i.pts })
          : i instanceof ke && Ze({ ...u, pos: i.center, radius: i.radius }),
          j()
      },
      area: {
        shape: e.shape ?? null,
  ...
  function Ps(e, n) {
    return {
      ...
      height: n,
      draw() {
        Oe(Object.assign(tt(this), { width: this.width, height: this.height }))
      },
      renderArea() {
        return new ne(S(0), this.width, this.height)
      },
  ...
  function Fs(e = {}) {
    ...
    return {
      ...
      update() {
        ...
        if (
          (u && ((r = null), (i = null), this.trigger("fallOff"), (u = !1)), r)
        )
  ...
  function Bs(e = 2) {
    ...
    return {
      ...
      doubleJump(r) {
        n <= 0 ||
          (n < this.numJumps && this.trigger("doubleJump"), n--, this.jump(r))
      },
      onDoubleJump(r) {
      ...
      z = o(() => {
        ...
        for (let R of r.children) {
          ...
          ;(R.tilePos.x != P.x || R.tilePos.y != P.y) &&
            ((y = !0), N(R), (R.tilePos.x = P.x), (R.tilePos.y = P.y), $(R))
        }
      ...
      Ue = {
        ...
        spawn(y, ...R) {
          ...
          let k = !1,
            X = !1
          for (let me of G)
            me.id === "tile" && (X = !0), me.id === "pos" && (k = !0)
          k || G.push(Nt()), X || G.push(or())
          let oe = r.add(G)
          return (
            k && (oe.tilePosOffset = oe.pos.clone()),
            (oe.tilePos = P),
            l &&
              ($(oe),
        ...
        getTilePath(y, R, P = {}) {
          ...
          for (me.set(G, 0); X.length !== 0; ) {
            ...
            for (let Ye of On) {
              ...
              ;(!me.has(Ye) || Pn < me.get(Ye)) &&
                (me.set(Ye, Pn),
                X.insert({ cost: Pn, node: Ye }),
                oe.set(Ye, Le))
            }
          }
          let An = [],
        ...
        getPath(y, R, P = {}) {
          ...
          return X
            ? [
                y,
                ...X.slice(1, -1).map((oe) => oe.scale(G, k).add(G / 2, k / 2)),
                R,
              ]
            : null
        },
  ...
  function ni(e, n = {}) {
    ...
    return (
      l.wait(0.4 / i, () => l.use(ur(i, u))), l.onDestroy(() => r.destroy()), r
    )
  }
  o(ni, "addKaboom")
  function cr() {
  ...
  function ii() {
    ...
    T.events.numListeners("loading") > 0
      ...
      : Ve(() => {
          ...
          Ce({ pos: S(0), width: we(), height: ye(), color: J(0, 0, 0) }),
            Ce({
              pos: i,
              width: n,
              height: r,
...
`),
  ...
  function Cn(e) {
    U.run(() => {
      Ve(() => {
        ...
        Ce({ width: i, height: u, color: J(0, 0, 255), fixed: !0 })
        let a = $e({
          ...l,
          text: e.name,
          pos: S(32),
  ...
  U.run(() => {
    B.loaded ||
      (Fe() === 1 && !qt && ((B.loaded = !0), T.events.trigger("load"))),
      (!B.loaded && s.loadingScreen !== !1) || qt
        ? (mt(), ii(), pt())
        : (se.paused || cr(), ri(), mt(), si(), s.debug !== !1 && oi(), pt()),
      qt && (qt = !1),
  ...
  o(hr, "updateViewport"),
    U.onResize(() => {
      ...
      ;(e && !s.stretch && !s.letterbox) ||
        ((c.width = c.offsetWidth * V),
        (c.height = c.offsetHeight * V),
        hr(),
        e ||
          (w.frameBuffer.free(),
          (w.frameBuffer = new Ge(h.drawingBufferWidth, h.drawingBufferHeight)),
          (w.width = h.drawingBufferWidth / V),
          (w.height = h.drawingBufferHeight / V)))
    }),
    hr()
